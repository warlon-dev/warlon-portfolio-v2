...
const About = () => {
  return (
    <div id='about' className='app__about'>
      ...
      <p className='p__text'>
        Hey there! I've been working as a software developer since 2015, teaming up with different companies and diving into exciting projects. From creating accounting software to handling payroll systems, I've had the chance to build solutions that make business processes smoother. And you know what? <span>My passion lies in helping great minds like yours bring innovative ideas to life</span>!
      </p>
      <p className='p__text'>
      ...
      <p className='p__text'>
        When it comes to software development, <span>I'm all about creating impact</span>. I'm not just about meeting functional requirements; I strive to deliver seamless user experiences that truly make a difference. By blending my technical expertise with a user-centric approach, I empower businesses and individuals with software that's intuitive and powerful. So, let's team up and make your innovative ideas a reality!
      </p>
    </div>
  )
}
